...
const Header = () => {
  ...
  return (
    <View className="px-[18.5px] py-[26px] border-b-[0.5px] bg-bgprimary border-[#E6E6E6] flex-row justify-between items-center">
      <View style={{ gap: 90 }} className="flex-row items-center">
        ...
        <Text className="font-grotesk_semibold text-white text-[24px] leading-8 text-primary-main">Dashbaord</Text>
      </View>
